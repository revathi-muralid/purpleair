...
sites5=read.csv("sites/sites_96.csv")
sites6=read.csv("sites/sites_97.csv")
sites7=read.csv("sites/sites_98.csv")
sites8=read.csv("sites/sites_99.csv")
sites9=read.csv("sites/sites_100.csv")
