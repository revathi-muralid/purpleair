...
sites5=read.csv("sites/sites_101.csv")
sites6=read.csv("sites/sites_102.csv")
sites7=read.csv("sites/sites_103.csv")
sites8=read.csv("sites/sites_104.csv")
sites9=read.csv("sites/sites_105.csv")
