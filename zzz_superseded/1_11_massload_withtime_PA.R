...
sites5=read.csv("sites/sites_86.csv")
sites6=read.csv("sites/sites_87.csv")
sites7=read.csv("sites/sites_88.csv")
sites8=read.csv("sites/sites_89.csv")
sites9=read.csv("sites/sites_90.csv")
