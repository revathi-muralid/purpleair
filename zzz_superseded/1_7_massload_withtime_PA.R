...
sites5=read.csv("sites/sites_66.csv")
sites6=read.csv("sites/sites_67.csv")
sites7=read.csv("sites/sites_68.csv")
sites8=read.csv("sites/sites_69.csv")
sites9=read.csv("sites/sites_70.csv")
