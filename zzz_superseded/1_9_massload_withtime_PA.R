...
sites5=read.csv("sites/sites_76.csv")
sites6=read.csv("sites/sites_77.csv")
sites7=read.csv("sites/sites_78.csv")
sites8=read.csv("sites/sites_79.csv")
sites9=read.csv("sites/sites_80.csv")
