...
sites5=read.csv("sites/sites_116.csv")
sites6=read.csv("sites/sites_117.csv")
sites7=read.csv("sites/sites_118.csv")
sites8=read.csv("sites/sites_119.csv")
sites9=read.csv("sites/sites_120.csv")
