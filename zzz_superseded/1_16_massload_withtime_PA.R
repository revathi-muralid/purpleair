...
sites5=read.csv("sites/sites_111.csv")
sites6=read.csv("sites/sites_112.csv")
sites7=read.csv("sites/sites_113.csv")
sites8=read.csv("sites/sites_114.csv")
sites9=read.csv("sites/sites_115.csv")
