...
sites5=read.csv("sites/sites_56.csv")
sites6=read.csv("sites/sites_57.csv")
sites7=read.csv("sites/sites_58.csv")
sites8=read.csv("sites/sites_59.csv")
sites9=read.csv("sites/sites_60.csv")
