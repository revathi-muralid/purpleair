...
sites5=read.csv("sites/sites_171.csv")
sites6=read.csv("sites/sites_172.csv")
sites7=read.csv("sites/sites_173.csv")
sites8=read.csv("sites/sites_174.csv")
sites9=read.csv("sites/sites_175.csv")
sites=rbindlist(list(sites5,sites6,sites7,sites8,sites9))
n.thread=4
start.date='2020-01-01'
end.date='2020-12-31'
average=60
time.zone='GMT'
output.path='./output/37'
