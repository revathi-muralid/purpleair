...
sites5=read.csv("sites/sites_156.csv")
sites6=read.csv("sites/sites_157.csv")
sites7=read.csv("sites/sites_158.csv")
sites8=read.csv("sites/sites_159.csv")
sites9=read.csv("sites/sites_160.csv")
