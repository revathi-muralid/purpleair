...
sites5=read.csv("sites/sites_50.csv")
sites6=read.csv("sites/sites_51.csv")
sites7=read.csv("sites/sites_52.csv")
sites8=read.csv("sites/sites_53.csv")
sites9=read.csv("sites/sites_54.csv")
sites10=read.csv("sites/sites_55.csv")
sites=rbindlist(list(sites5,sites6,sites7,sites8,sites9,sites10))
n.thread=4
start.date='2020-01-01'
end.date='2020-12-31'
average=60
time.zone='GMT'
output.path='./output/13'
