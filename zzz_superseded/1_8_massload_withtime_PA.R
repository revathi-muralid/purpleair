...
sites5=read.csv("sites/sites_71.csv")
sites6=read.csv("sites/sites_72.csv")
sites7=read.csv("sites/sites_73.csv")
sites8=read.csv("sites/sites_74.csv")
sites9=read.csv("sites/sites_75.csv")
