...
sites5=read.csv("sites/sites_106.csv")
sites6=read.csv("sites/sites_107.csv")
sites7=read.csv("sites/sites_108.csv")
sites8=read.csv("sites/sites_109.csv")
sites9=read.csv("sites/sites_110.csv")
