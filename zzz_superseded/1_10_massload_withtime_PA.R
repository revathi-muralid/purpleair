...
sites5=read.csv("sites/sites_81.csv")
sites6=read.csv("sites/sites_82.csv")
sites7=read.csv("sites/sites_83.csv")
sites8=read.csv("sites/sites_84.csv")
sites9=read.csv("sites/sites_85.csv")
