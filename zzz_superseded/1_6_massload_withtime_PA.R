...
sites5=read.csv("sites/sites_61.csv")
sites6=read.csv("sites/sites_62.csv")
sites7=read.csv("sites/sites_63.csv")
sites8=read.csv("sites/sites_64.csv")
sites9=read.csv("sites/sites_65.csv")
